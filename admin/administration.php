...
function toggleDropdown() {
    ...
    <div class="container-fluid">
        <div class="row">
            <!-- Change Username Section (swapped to first position) -->
            <div class="col-sm-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="usernameForm" method="POST" action="change_username.php">
                            <div class="mb-3">
                                <label class="form-label" for="current-username">Current Username:</label>
                                <input class="form-control" id="current-username" name="current_username" type="text" placeholder="Enter current username" disabled>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="new-username">New Username:</label>
                                <input class="form-control" id="new-username" name="new_username" type="text" placeholder="Enter new username" disabled>
                            </div>
                            <div class="form-footer">
                                <button type="button" class="btn btn-primary btn-pill" id="editUsernameButton">Edit</button>
                                <button class="btn btn-success btn-pill" type="submit" id="saveUsernameButton" style="display: none;">Save</button>
                                <button type="button" class="btn btn-danger btn-pill" id="cancelUsernameButton" style="display: none;">Cancel</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <!-- Change Password Section (swapped to second position) -->
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                    ...
                    <div class="card-body">
                        <!-- Include Font Awesome CSS for the eye icon -->
                        ...
                        <form id="passwordForm" method="POST" action="change_password.php">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="current-password" name="current_password" type="password" placeholder="Enter current password" disabled>
                                    <button type="button" class="btn btn-outline-secondary" id="toggleCurrentPassword" style="display: none;">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="new-password" name="new_password" type="password" placeholder="Enter new password" disabled>
                                    <button type="button" class="btn btn-outline-secondary" id="toggleNewPassword" style="display: none;">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="confirm-password">Retype Password:</label>
                                <div class="input-group">
                                    <input class="form-control" id="confirm-password" name="confirm_new_password" type="password" placeholder="Retype new password" disabled>
                                    <button type="button" class="btn btn-outline-secondary" id="toggleConfirmPassword" style="display: none;">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="form-footer">
                                <button type="button" class="btn btn-primary btn-pill" id="editButton">Edit</button>
                                <button class="btn btn-success btn-pill" type="submit" id="saveButton" style="display: none;">Save</button>
                                <button type="button" class="btn btn-danger btn-pill" id="cancelButton" style="display: none;">Cancel</button>
                            </div>
...
<script>
                    // JavaScript to handle form behavior
                    ...
                    document.getElementById('cancelButton').addEventListener('click', function() {
                        ...
                        // Hide Save and Cancel buttons and show the Edit button
                    ...
                    function showEyeIcons() {
                        document.getElementById('toggleCurrentPassword').style.display = 'inline';
                        document.getElementById('toggleNewPassword').style.display = 'inline';
                        document.getElementById('toggleConfirmPassword').style.display = 'inline';
                    }
                    ...
                    // Add event listeners for eye icon toggles
                    ...
                    // Initially hide eye icons
                    hideEyeIcons();
                  </script>

<script>
    // JavaScript to handle the Change Username form behavior
    document.getElementById('editUsernameButton').addEventListener('click', function() {
        // Enable the form fields
        document.getElementById('current-username').disabled = false;
        document.getElementById('new-username').disabled = false;

        // Hide the Edit button and show Save and Cancel buttons
        this.style.display = 'none';
        document.getElementById('saveUsernameButton').style.display = 'inline-block';
        document.getElementById('cancelUsernameButton').style.display = 'inline-block';
    });
    ...
    document.getElementById('cancelUsernameButton').addEventListener('click', function() {
        ...
        // Disable the form fields
        document.getElementById('current-username').disabled = true;
