                ...
                <li>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                      <p><a href="invoice-template.php">Tickets Generated</a><span class="pull-right">1 hr</span></p>
                    </div>
                  </div>
                </li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addPatientForm">
                    ...
                    <button type="submit" class="btn btn-primary" style="margin-top: 10px;">Save Patient</button>
                </form>
            </div>
        </div>
    </div>
