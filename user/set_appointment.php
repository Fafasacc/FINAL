...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('/user/assets/images/Bg.jpg');
    ...
    <div class="form-card">
        ...
        <form id="vetForm">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ownerName" placeholder="Owner's Name" oninput="validateOwnerName(this)">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="petAge" placeholder="Pet's Age">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="chiefComplaint" rows="3" placeholder="Chief Complaint"></textarea>
                    </div>
                    <div class="form-group">
            ...
            <div class="form-footer">
                ...
                <button type="submit" style="padding-left: 20px;border-left-width: 20px;margin-left: 15px;">Submit</button>
            </div>
        </form>
    </div>
